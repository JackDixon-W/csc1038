...
float avg_pop(struct Country *countries, int length);
...
int main(int argc, char *argv[])
{
    ...
    printf("Population average: %.2f\n", avg_pop(countries, lenCountry));
    return 0;
}

// Function for totalling up the average population
float avg_pop(struct Country *countries, int length)
{
    // Initialise variables/pointers
    float total = 0;
